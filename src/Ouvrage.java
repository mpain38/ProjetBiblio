...
public class Ouvrage extends Document implements Serializable {
	 ...
	 */
	public Ouvrage(String isbn, String titre, Auteur auteur, String editeur, GregorianCalendar dateEdition, HashSet<MotCle> mot) {
	...
	public void setAuteur(Auteur aut) {
		super.setAuteur(aut);
		aut.ajouterOuvrage(this);
	}

	public void setMotCle(MotCle mot) {
		super.setMotCle(mot);
		mot.ajouterOuvrage(this);
	}
