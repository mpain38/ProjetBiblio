 ...
 * @version 1.0
 */
public class VueSaisieExemplaire extends Vue implements Observer{
	...
	public VueSaisieExemplaire(Controleur controleur) {
		...
		JLabel lblNewLabel_1 = new JLabel("Date reception (MM/AAAA)");
		lblNewLabel_1.setBounds(36, 115, 144, 15);
		...
		public void alimente(Ouvrage ouv) {
			...
			for (Exemplaire exemplaire : ouv.getExemplaires()) {
				  textAreaInfosExemplaires.append( "numero " + String.valueOf(exemplaire.getNumero()) 
